...
# ------------------------------------------------
# Author:       hastakh
# Created:      Tue Aug 29 14:29:06 IST 2023
#
# Modifier:     hastakh
# Modified:     Tue Aug 29 14:29:06 IST 2023
#
# Usage:
#        --help
#
...
function getOpt() {
    ...
    # set the list of arguments equal to  : set them in proper order.
    eval set -- "$OPTS"
    while true; do
        case "$1" in
...
function getScriptsDir () {
     ...
     # While  is a symlink, resolve it
     while [ -h "$SOURCE" ]; do
          DIR="$( cd -P "$( dirname "$SOURCE" )" && pwd )"
          SOURCE=""
          # If  was a relative symlink (so no "/" as prefix, need to resolve it relative to the symlink base directory
